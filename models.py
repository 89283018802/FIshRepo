...
class Pool(db.Model):
    ...
    square = db.Column(db.Float, nullable=True)
    deep = db.Column(db.Float, nullable=True)
...
class FishBoning(db.Model):
    ...
    fish_survival = db.Column(db.Float, nullable=True)
    fish_biometric = db.Column(db.Text, nullable=True)
...
class FishMovement(db.Model):
    ...
    fish_biomass = db.Column(db.Float, nullable=False)
    movement_reason = db.Column(db.Enum(MovementReason), nullable=False)
